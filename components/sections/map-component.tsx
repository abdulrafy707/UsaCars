...
import type { PathOptions } from "leaflet"; // ✅ Import PathOptions for styling
...
export default function MapComponent({ highlightedCountries }: { highlightedCountries: string[] }) {
  ...
  // ✅ Fix: Explicitly type `feature` as `Feature<Geometry, GeoJsonProperties>`
  const countryStyle = (feature: Feature<Geometry, GeoJsonProperties>): PathOptions => {
  ...
  return (
    <div className="w-full h-full">
      ...
      >
        ...
        />
        {geoData && <GeoJSON data={geoData} style={countryStyle} />} {/* ✅ Fixed type issue */}
      </MapContainer>
    </div>
  );
}
